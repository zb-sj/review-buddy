...
3. **Tool Recommendations**:
   - "💡 Pro-tip: Include a Figma link in your PR description for automated design comparison."
   - "💡 Pro-tip: Use Playwright's visual regression testing to capture and compare snapshots automatically."
...
- `figma_assets` — map of nodeId → {screenshot_url, metadata, code_context}
- `regression_pairs` — list of {expected, actual, diff} snapshot paths
- `mobile_assets` — list of changed mobile images
